        ...
        return JSONObject().apply {
            ...
            put(
                ...
                JSONObject().apply {
                    ...
                    put(
                        "user_unlocked",
                        user?.isUserUnlocked ?: JSONObject.NULL
                    )
                    put(
                        "power_save_mode",
                        power?.isPowerSaveMode ?: JSONObject.NULL
                    )
                    put(
            ...
            put(
                ...
                JSONObject().apply {
                    ...
                    put(
                        "database_size_bytes",
                        db.databaseSizeBytes()
                    )
                    put(
                        "local_daily_reports_count",
                        reports.reportCount()
                    )
                    put(
                        "local_daily_reports_bytes",
                        reports.totalBytes()
                    )
                    put(
                        "privacy_setup_complete",
                        PrivatePreferences(context)
                            .setupComplete()
                    )
                    put(
            ...
            put(
                ...
                JSONObject().apply {
                    put(
                        "APP",
                        counts[IntervalType.APP] ?: 0
                    )
                    put(
                        "PRIVATE",
                        counts[IntervalType.PRIVATE] ?: 0
                    )
                    put(
                        "SCREEN_OFF",
                        counts[IntervalType.SCREEN_OFF] ?: 0
                    )
                    put(
                        "ANONYMOUS_BROWSER",
            ...
            put(
                ...
                JSONObject().apply {
                    ...
                    put(
                        "anonymous_browser_schema_ready",
                        true
                    )
            ...
            put(
                ...
                JSONObject().apply {
                    put(
                        "private_reason_exported",
                        false
                    )
                    put(
                        "private_package_exported",
                        false
                    )
                    put(
                        "full_url_exported",
                    ...
                    put(
                        "screen_or_input_content_exported",
                        false
                    )
                }
            )
